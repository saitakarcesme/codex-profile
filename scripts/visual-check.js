      ...
      window.__TAURI_INTERNALS__ = {
        invoke: async (command) => {
          ...
          if (command === "list_profiles") {
            return {
              profiles: [
                { id: "11111111-1111-4111-8111-111111111111", label: "Personal", active: true, status: "ready" },
                { id: "22222222-2222-4222-8222-222222222222", label: "Secondary", active: false, status: "ready" },
                { id: "33333333-3333-4333-8333-333333333333", label: "Ibrahim Sait", active: false, status: "ready" },
              ],
            };
          }
          return null;
